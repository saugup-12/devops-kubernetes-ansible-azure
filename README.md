...
### SSL in Hyperkube
Currently, kubeadm does not correctly host mount certificates into the apiserver and controller-manager, resulting in errors when the cloud provider tries to communicate with the Azure Rest APIs. [Issue 36150](https://github.com/kubernetes/kubernetes/issues/36150) describes this issue in detail.
